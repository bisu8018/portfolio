...
/**
 * RNB(우측 내비게이션 바) 내에서 공통 버튼 스타일을 적용하는 래퍼 컴포넌트
 *
 * @param {RnbBtnWrapperProps} props - 버튼 스타일 및 렌더링할 자식 노드, 활성화 여부 등
 */
export default function RnbBtnWrapper({ children, enabled, title, ...props }: RnbBtnWrapperProps) {
